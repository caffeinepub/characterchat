...
import type { Character as _Character, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addMessage(arg0: bigint, arg1: string, arg2: string): Promise<ChatMessage> {
        if (this.processError) {
            try {
    ...
    async clearChatHistory(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearChatHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createCharacter(arg0: string, arg1: string, arg2: string, arg3: string, arg4: Array<string>, arg5: Array<string>, arg6: boolean, arg7: string | null): Promise<Character> {
        if (this.processError) {
            try {
                const result = await this.actor.createCharacter(arg0, arg1, arg2, arg3, arg4, arg5, arg6, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg7));
    ...
    async getCharacter(arg0: bigint): Promise<Character | null> {
        if (this.processError) {
            try {
    ...
    async getCharactersByUser(arg0: Principal): Promise<Array<Character>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCharactersByUser(arg0);
                return from_candid_vec_n7(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveCallerUserProfile(arg0: string, arg1: string, arg2: boolean): Promise<UserProfile> {
        if (this.processError) {
            try {
    ...
    async updateCharacter(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<string>, arg6: Array<string>, arg7: boolean, arg8: string | null): Promise<Character> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCharacter(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, to_candid_opt_n3(this._uploadFile, this._downloadFile, arg8));
                return from_candid_Character_n4(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Character]): Character | null {
    return value.length === 0 ? null : from_candid_Character_n4(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_vec_n7(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Character>): Array<Character> {
